      ...
      <div className="mt-8 flex flex-wrap justify-center gap-4">
        <a
          className="block w-full rounded
           ...
           font-medium text-white shadow
            hover:bg-gray-400 focus:outline-none focus:ring active:bg-red-500 sm:w-auto"
          href="/upload"
        >
          Get Started
        </a>
        ...
        <a
          ...
          text-sm font-medium text-primary shadow
           hover:text-gray-400 focus:outline-none focus:ring active:text-red-500 sm:w-auto"
          href="/about"
        >
          Learn More
        </a>
